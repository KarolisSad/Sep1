...
public class testForWWW
{
  public static void main(String[] args)
  {
    ...
    //Courses
    {
      SMM.addCourse("SDJ", 10, "1X", "SVA");
      SMM.getCourseList().getCourseByName("SDJ1X").addTeacherToCourse(
          SMM.getTeacherByID("RIB"));
      SMM.addCourse("SDJ", 10, "1Y", "SVA");
      SMM.addCourse("SDJ", 10, "1DK", "SVA");
      SMM.addCourse("SEP", 10, "1X", "MWA");
      SMM.addCourse("SEP", 10, "1Y", "MWA");
      SMM.addCourse("SEP", 10, "1DK", "MWA");
      SMM.addCourse("RWD", 5, "1X", "LILE");
      SMM.addCourse("RWD", 5, "1Y", "LILE");
      SMM.addCourse("RWD", 5, "1DK", "LILE");
    }
    //Sessions
    {
