...
public class AddCourseViewController
{
  ...
  public void reset()
  {
    ...
    myClass.setText("");
    teacher.setText("");
    courseName.setPromptText("e.g. SDJ");
    ects.setPromptText("e.g. 5");
    myClass.setPromptText("e.g. 1X");
    teacher.setPromptText("e.g. RIN");
  ...
  @FXML private void submit()
  {
    ...
    model.addCourse(courseName.getText()+myClass.getText(),Integer.parseInt(ects.getText()),myClass.getText(),teacher.getText());
