...
public class CourseViewController
{
  ...
  @FXML private void removeButton()
  {
    try
    {
      ...
      if (remove)
      {
        Course course = new Course(selectedItem.getFinalCourseNameProperty().get(),
            selectedItem.getEctsProperty().get(),
            new Class(selectedItem.getClassIdProperty().get(),
                selectedItem.getSemesterProperty().get()),
            new Teacher(selectedItem.getTeacherProperty().get(),
                new TeacherID(selectedItem.getTeacherIdProperty().get())));
        model.removeCourseBy(selectedItem.getFinalCourseNameProperty().get());
  ...
  public boolean confirmation()
  {
    ...
    alert.setHeaderText("Removing Course {"+selectedItem.getFinalCourseNameProperty().get()+":" + selectedItem.getTeacherIdProperty().get()+"}");
