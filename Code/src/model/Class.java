...
public class Class
{
  ...
  private StudentList classStudentList;
  ...
  {
    this.classStudentList = new StudentList();
  ...
  {
    classStudentList.addStudent(student);
  }

  //It may be deleted
  public void removeStudentFromClass(Student student)
  {
    classStudentList.removeStudent(student);
  }
  ...
  public void removeStudentFromClass(String studentID)
  {
    ...
    {
      if (classStudentList.getStudent(i).getStudentId().equals(studentID))
      {
        classStudentList.removeStudentByIndex(i);
        break;
      }
      else
  ...
  {
    return classStudentList.contains(student);
  }
  ...
  public boolean equals(Object obj)
  {
    ...
    return className == other.className && classStudentList.equals(
        other.classStudentList);
  }
