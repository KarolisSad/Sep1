...
public class DateTime
{
  ...
  /**
   * A method calling the getDayName method from Date-class
   * @return String holding the dayname of the DateTime object.
   */
  ...
  /**
   * A method returning a String showing the date and time in a presentable manner.
   * @return a String showing the date and time in a presentable manner.
   */
