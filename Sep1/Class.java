...
public class Class
{
  ...
  /**
   * method creates a string variable that contains class name and number of students and student list.
   * The loop is meant for looping through all students in the list and putting them in the readable list and is added to the s string.
